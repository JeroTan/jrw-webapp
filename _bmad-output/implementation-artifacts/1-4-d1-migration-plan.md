...
| Migration files | `migrations/0000_classy_menace.sql` through `migrations/0014_admin_lifecycle_reasons.sql` | Fifteen migration entries tracked. Story 1.11 adds nullable Admin lifecycle reason columns after Story 1.10 migration `0013_wakeful_crystal.sql`. |
| Migration journal | `migrations/meta/_journal.json` | Version `7`, dialect `sqlite`, entries idx `0` through `14`. |
