...
Use `bmad-review-adversarial-general`. Review only diff below. Assume no conversation context, no specification, and no project access. Return Markdown findings list required by skill.
...
diff --git a/_bmad-output/implementation-artifacts/spec-stabilize-vitest-worker-lifecycle.md b/_bmad-output/implementation-artifacts/spec-stabilize-vitest-worker-lifecycle.md
new file mode 100644
--- /dev/null
+++ b/_bmad-output/implementation-artifacts/spec-stabilize-vitest-worker-lifecycle.md
@@ -0,0 +1,65 @@
+---
