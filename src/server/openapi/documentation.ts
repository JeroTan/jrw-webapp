export const openApiDocumentation = {
  ...
  tags: [
    ...
    { name: "Checkout", description: "Cart validation, inventory reservation, and payment handoff." },
    { name: "Payments", description: "PayMongo payment state and webhook reconciliation." },
    { name: "Orders", description: "Customer order status and Admin fulfillment operations." },
    { name: "Returns/Refunds", description: "Manual return and refund recording." },
    { name: "Assets", description: "Product asset metadata and R2-backed media." },
