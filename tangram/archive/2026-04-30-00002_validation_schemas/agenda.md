...
**Feature ID:** 00002
**Context:** The goal is to establish a modular, dual-layer validation and type system. Custom Zod wrappers (`src/lib/zod/wrappers.ts`) drive frontend forms and complex API response casting. Native TypeBox (`t`) handles Elysia API boundary validation and Swagger documentation.
